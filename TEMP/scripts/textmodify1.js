...
function findIncrementLevel(targetElementId) {
	var currentNativeSizeText = getStyle(document.getElementsByTagName('body')[0], "font-size");
	var currentNativeSize = parseInt(currentNativeSizeText.replace("px",""));
	var currentSizeText = getStyle(document.getElementById(contentFrame), "font-size");
	var currentSize = parseInt(currentSizeText.replace("px",""));
	
	return (currentSize-currentNativeSize);
}